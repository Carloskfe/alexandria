...
export class RenameCreditsToTokens1714000000038 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "subscriptions" RENAME COLUMN "creditBalance" TO "tokenBalance"`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "subscriptions" RENAME COLUMN "tokenBalance" TO "creditBalance"`);
