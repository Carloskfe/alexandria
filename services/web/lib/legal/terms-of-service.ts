...
| Plan | Mensual | Anual |
|------|---------|-------|
| Individual | $9,99 USD | $89 USD |
| Dual Reader (hasta 2 perfiles simultáneos) | $14,99 USD | $135 USD |
...
- Acceder al contenido fuera de los mecanismos autorizados por la plataforma.
- Compartir credenciales de cuenta (excepto el plan Dual Reader, limitado a 2 perfiles).

El incumplimiento puede resultar en la suspensión inmediata de la cuenta sin reembolso.

## 5. Fragmentos y contenido generado por el usuario
...
EL SERVICIO SE PROPORCIONA "TAL CUAL" Y "SEGÚN DISPONIBILIDAD". ALEXANDRIA NO GARANTIZA QUE EL SERVICIO SEA ININTERRUMPIDO, LIBRE DE ERRORES O COMPLETAMENTE SEGURO.

## 8. Limitación de responsabilidad

EN LA MÁXIMA MEDIDA PERMITIDA POR LA LEY APLICABLE, ALEXANDRIA NO SERÁ RESPONSABLE DE DAÑOS INDIRECTOS, INCIDENTALES, ESPECIALES O CONSECUENTES. LA RESPONSABILIDAD TOTAL DE ALEXANDRIA NO SUPERARÁ EL IMPORTE PAGADO POR EL USUARIO EN LOS ÚLTIMOS 12 MESES.

## 9. Ley aplicable y jurisdicción

Estos términos se rigen por la ley española. Cualquier disputa se someterá a los tribunales competentes de España, salvo que la legislación aplicable en tu país de residencia establezca otra jurisdicción obligatoria.
...
|------|---------|--------|
| Individual | $9.99 USD | $89 USD |
| Dual Reader (up to 2 simultaneous profiles) | $14.99 USD | $135 USD |
...
- Accessing content outside the mechanisms authorised by the platform.
- Sharing account credentials (except the Dual Reader plan, limited to 2 profiles).

Violations may result in immediate account suspension without refund.

## 5. Fragments and User-Generated Content
...
THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE". ALEXANDRIA DOES NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED, ERROR-FREE, OR COMPLETELY SECURE.

## 8. Limitation of Liability

TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, ALEXANDRIA SHALL NOT BE LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, OR CONSEQUENTIAL DAMAGES. ALEXANDRIA'S TOTAL LIABILITY SHALL NOT EXCEED THE AMOUNT PAID BY THE USER IN THE PRECEDING 12 MONTHS.

## 9. Governing Law and Jurisdiction

These terms are governed by Spanish law. Any dispute shall be submitted to the competent courts of Spain, unless applicable law in your country of residence mandates a different jurisdiction.
