...
**CI/CD**
- [ ] Configure GitHub Actions: lint, test, build on PR — 1d
...
**Sprint 2.3 total: 5d** _(light sprint — buffer for Stage 1–2 carry-over)_
...
- [ ] End-to-end test suite (Playwright): auth, reader, sharing flow — 2d
...
| Stage | Name                        | Sprints | Estimated Weeks |
|-------|-----------------------------|---------|-----------------|
| 0     | Foundation                  | 1       | 2               |
| 1     | Core Platform               | 3       | 6               |
| 2     | Social Layer                | 3       | 6               |
| 3     | Monetization & Publishers   | 2       | 4               |
| 4     | Mobile & Offline            | 3       | 6               |
| 5     | Launch & QA                 | 2       | 4               |
| **—** | **Total**                   | **14**  | **28 weeks**    |

> Estimates assume 1 senior full-stack developer. With a team of 2–3, total calendar time reduces to ~12–16 weeks depending on parallel workstreams.
